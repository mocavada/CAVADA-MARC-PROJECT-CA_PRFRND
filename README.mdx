...
This MDX version:  
- Properly wraps all C#, JSON, and HTTP code blocks  
- Mermaid diagram uses simplified labels to avoid parse errors  
- Ready for **VS Code MDX rendering** and **Pandoc PDF conversion**  
